...
def save_results(all_masks, video_path, output_path, mask_dir, save_to_video, 
    ...
    # 颜色映射（用于可视化）- 20色高饱和度方案
    color_map = [
        (255, 0, 0), (255, 100, 0), (255, 165, 0), (0, 255, 0),
        (0, 255, 127), (0, 255, 255), (0, 150, 255), (0, 0, 255),
        (128, 0, 255), (255, 0, 255), (255, 0, 127), (255, 50, 150),
        (255, 127, 80), (150, 255, 0), (0, 200, 150), (0, 180, 200),
        (75, 0, 200), (200, 0, 200), (200, 0, 50), (50, 255, 50)
    ]
